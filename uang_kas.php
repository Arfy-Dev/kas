                          ...
                          <div class="row">
                            ...
                            <div class="col-lg">
                              <div class="form-group">
                                ...
                                <input type="number" required name="tahun" disabled min="<?= date('Y'); ?>" value="<?= date('Y'); ?>" class="form-control">
                                <input type="hidden" required name="tahun" min="<?= date('Y'); ?>" value="<?= date('Y'); ?>" class="form-control">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="pembayaran_perminggu">Pembayaran Perminggu</label>
                            <input type="number" name="pembayaran_perminggu" id="pembayaran_perminggu" required class="form-control" placeholder="Rp." min="0" max="500000">
                          </div>
                        </div>
