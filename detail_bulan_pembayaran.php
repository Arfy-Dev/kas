...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="form-group">
                                ...
                                <input max="<?= $duk['pembayaran_perminggu']; ?>" type="number" required min="0" oninput="validasiInput(this)" name="minggu_ke_1" class="form-control" value="<?= $duk['minggu_ke_1']; ?>">
                              </div>
                            </div>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="form-group">
                                ...
                                <input max="<?= $duk['pembayaran_perminggu']; ?>" type="number" required min="0" oninput="validasiInput(this)" name="minggu_ke_2" class="form-control" value="<?= $duk['minggu_ke_2']; ?>">
                              </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-fw fa-times"></i> Close</button>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="form-group">
                                ...
                                <input max="<?= $duk['pembayaran_perminggu']; ?>" type="number" required min="0" oninput="validasiInput(this)" name="minggu_ke_3" class="form-control" value="<?= $duk['minggu_ke_3']; ?>">
                              </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-fw fa-times"></i> Close</button>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="form-group">
                                ...
                                <input max="<?= $duk['pembayaran_perminggu']; ?>" required type="number" min="0" oninput="validasiInput(this)" name="minggu_ke_4" class="form-control" value="<?= $duk['minggu_ke_4']; ?>">
                              </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-fw fa-times"></i> Close</button>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2020 By Kelompok 4.</strong>
      All rights reserved.
  ...
  <script>
    function validasiInput(input) {
      ...
      // Tampilkan pesan kesalahan jika input tidak berisi angka
      var pesanError = document.getElementById('pesanError');
      if (input.value.length === 0) {
        pesanError.textContent = 'Masukkan hanya angka.';
      } else {
